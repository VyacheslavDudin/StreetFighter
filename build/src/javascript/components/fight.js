...
export async function fight(_firstFighter, _secondFighter) {
    return new Promise((resolve) => {
        ...
        let { PlayerOneCriticalHitCombination: hitCritComb1, PlayerTwoCriticalHitCombination: hitCritComb2, PlayerOneAttack: playerOneAttack, PlayerOneBlock: playerOneBlock, PlayerTwoAttack: playerTwoAttack, PlayerTwoBlock: playerTwoBlock, } = controls;
        ...
        function keyDownListener(event) {
            if (controlKeys.has(event.code)) {
                ...
                return;
            if (((comboKeysPressed(hitCritComb1) ||
